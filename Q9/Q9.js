...
function sortByRating(products, order) {
...
document.getElementById('sortRatingAsc').addEventListener('click', () => {
    const sorted = sortByRating(products, 'asc');
    displayProducts(sorted);
});

document.getElementById('sortRatingDesc').addEventListener('click', () => {
    const sorted = sortByRating(products, 'desc');
    displayProducts(sorted);
});
